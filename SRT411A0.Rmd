...
This assignment is base on the todo labs fro, PDF file named A-very-short-introduction-to-R  which is available in repository for download. The Short introduction to R is also available in: 
https://cran.r-project.org/doc/contrib/Torfs+Brauer-Short-R-Intro.pdf

Sources for this poroject:
